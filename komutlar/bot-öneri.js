...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`);  
  ...
  var guildID = "753998135021535312"; // Sunucu ID
 
  var channelID = "753998135595892767"; // Kanal ID
  ...
  if (!öneri) {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .addField("<a:hypesquad1:760825684305510410> • Öneren Kullanıcı:", message.author.tag, true)
 
      .addField("<a:hypesquad1:760825684305510410> • Öneren Kullanıcı ID:", message.author.id,true)
 
      .addField("<a:hypesquad1:760825684305510410> • Önerisi:", öneri)
